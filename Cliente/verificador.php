...
<?php 
        ...
        if($state=="approved"){
                ...
                $sentencia=$pdo->prepare("UPDATE `venta` 
                ...
                $sentencia=$pdo->prepare("UPDATE venta SET status='completo' 
...
<div class="jumbotron">
        ...
        if($completado>=1){
               ...
               $sentencia=$pdo->prepare("SELECT * FROM det_vta,producto 
               WHERE det_vta.IDINVENTARIO=producto.ID 
               AND det_vta.IDVENTA=:ID");
        ...
        <div class="row">
         ...
         <form action="factura.php" method="get">
             ...
             <button href="factura.php?id=<?php echo $idc;?>" class="btn btn-success" type="submit">Descargar</button>
             </form>
</div>
<?php
